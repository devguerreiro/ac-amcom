...
// app services
import useAddProduct from "@/components/sale/edit/SaleEditAddProduct.view";

// app components
import SaleEditAddProductList from "./SaleEditAddProductList";

interface IProps {
    sx?: SxProps;
}

export default memo(function SaleEditAddProduct(props: IProps) {
    const { sx } = props;
