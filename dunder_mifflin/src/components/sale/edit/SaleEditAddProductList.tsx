...
// app services
import { TEditSaleSchema } from "@/domain/schemas/sale";

import useProductList from "./SaleEditAddProductList.view";

interface IItem extends FieldArrayWithId<TEditSaleSchema, "items", "id"> {}
...
export default memo(function SaleEditAddProductList(props: IProps) {
